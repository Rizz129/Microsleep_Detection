...
Program dimulai dengan menginisialisasi semua library dan variabel yang diperlukan, kemudian menampilkan GUI utama. Sistem menunggu hingga pengguna menekan tombol “Mulai Deteksi”. Setelah tombol ditekan, kamera diaktifkan dan program mulai mendeteksi wajah menggunakan Mediapipe.

Jika wajah tidak terdeteksi, status “NOFACE” ditampilkan dan alarm dimatikan. Jika wajah terdeteksi, program menghitung nilai EAR untuk mengetahui apakah mata terbuka atau terpejam. Bila EAR di bawah ambang batas, waktu pejam akan bertambah; jika waktu pejam melebihi batas tertentu, sistem menganggap terjadi MicroSleep, menyalakan alarm, dan menampilkan peringatan. Sebaliknya, jika EAR normal, waktu pejam di-reset dan alarm dimatikan.

Selama proses berlangsung, sistem juga memeriksa apakah pengguna menekan tombol STOP atau apakah wajah hilang dalam waktu lama. Jika salah satu kondisi tersebut terpenuhi, kamera dimatikan, alarm dihentikan, dan proses selesai.
